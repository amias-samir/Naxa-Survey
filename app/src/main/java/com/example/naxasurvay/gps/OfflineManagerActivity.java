...
public class OfflineManagerActivity  extends AppCompatActivity {
    ...
    private void downloadRegionDialog() {
        ...
        regionNameEdit.setHint("set_region_name_hint");
                ...
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (regionName.length() == 0) {
                            Toast.makeText(OfflineManagerActivity.this, "Toast", Toast.LENGTH_SHORT).show();
                        } else {
        ...
        offlineManager.listOfflineRegions(new OfflineManager.ListOfflineRegionsCallback() {
            ...
            public void onList(final OfflineRegion[] offlineRegions) {
                ...
                if (offlineRegions == null || offlineRegions.length == 0) {
                    Toast.makeText(getApplicationContext(), "No region yet", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                AlertDialog dialog = new AlertDialog.Builder(OfflineManagerActivity.this)
                        ...
                        .setNeutralButton("Navigate Neutral Title", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int id) {
                        ...
                        .setNegativeButton("No button tittle", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int id) {
    ...
    private String getRegionName(OfflineRegion offlineRegion) {
        ...
        try {
            ...
            regionName = String.format("Regin Name", offlineRegion.getID());
        }
        return regionName;
    }
